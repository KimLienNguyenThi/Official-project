...
-- Them Sach
INSERT INTO SACH ( TENSACH, THELOAI, TACGIA, NGONNGU, NXB, NAMXB, URL_IMAGE, MOTA, LOAISACH, SOLUONGHIENTAI) 
...
của tác giả càng trở nên độc đáo và thu hút.', 0, 0);
INSERT INTO SACH ( TENSACH, THELOAI, TACGIA, NGONNGU, NXB, NAMXB, URL_IMAGE, MOTA, LOAISACH, SOLUONGHIENTAI) 
...
Thông qua câu chuyện người xem sẽ làm quen với vị Bảng nhãn Lê Quý Đôn - nhà bác học lỗi lạc của văn hóa Việt Nam!',0, 0);
INSERT INTO SACH ( TENSACH, THELOAI, TACGIA, NGONNGU, NXB, NAMXB, URL_IMAGE, MOTA, LOAISACH, SOLUONGHIENTAI) 
...
Với tác phẩm này, ông vẫn luôn giữ thông điệp khơi dậy khao khát sống đẹp, sống tử tế nơi người đọc.',1, 0);
INSERT INTO SACH ( TENSACH, THELOAI, TACGIA, NGONNGU, NXB, NAMXB, URL_IMAGE, MOTA, LOAISACH,SOLUONGHIENTAI) 
...
Cuộc sống tự do và cuộc đời phóng khoáng cởi mở đã để lại ấn tượng sâu sắc trong tâm khảm người đọc nhiều thế hệ suốt những năm tháng qua',0,  0);
INSERT INTO SACH ( TENSACH, THELOAI, TACGIA, NGONNGU, NXB, NAMXB, URL_IMAGE, MOTA,LOAISACH, SOLUONGHIENTAI) 
...
Tác phẩm là bản anh hùng ca ca ngợi sức lao động và khát vọng của con người.',0, 0);
INSERT INTO SACH ( TENSACH, THELOAI, TACGIA, NGONNGU, NXB, NAMXB, URL_IMAGE, MOTA,LOAISACH, SOLUONGHIENTAI) 
...
- Các bài tự kiểm tra, đánh giá mức độ hiểu kiến thức',0, 0); 
INSERT INTO SACH ( TENSACH, THELOAI, TACGIA, NGONNGU, NXB, NAMXB, URL_IMAGE, MOTA,LOAISACH, SOLUONGHIENTAI) 
...
tài liệu giảng dạy hữu ích ở các trung tâm dạy tiếng Trung Quốc mà còn rất thích hợp với những người muốn tự học ngôn ngữ này.', 0, 0);
INSERT INTO SACH ( TENSACH, THELOAI, TACGIA, NGONNGU, NXB, NAMXB, URL_IMAGE, MOTA, LOAISACH,SOLUONGHIENTAI) 
...
sự bao la của thế giới nghệ thuật và hướng đến những giá trị tinh thần tốt đẹp của nhân loại.',0,0);
INSERT INTO SACH ( TENSACH, THELOAI, TACGIA, NGONNGU, NXB, NAMXB, URL_IMAGE, MOTA, LOAISACH,SOLUONGHIENTAI) 
...
từ nhữ mang tính ứng dụng cao.', 0, 0);
...
sự vô hạn của kiến thức khoa học và công nghệ, sự bao la của thế giới nghệ thuật và hướng đến những giá trị tinh thần tốt đẹp của nhân loại.',0,0);
INSERT INTO SACH ( TENSACH, THELOAI, TACGIA, NGONNGU, NXB, NAMXB, URL_IMAGE, MOTA, LOAISACH,SOLUONGHIENTAI) 
...
khiến bộ môn Nhân số học khởi nguồn từ nhà toán học Pythagoras trở nên gần gũi, dễ hiểu hơn với độc giả Việt Nam.',1,0);
INSERT INTO SACH ( TENSACH, THELOAI, TACGIA, NGONNGU, NXB, NAMXB, URL_IMAGE, MOTA,LOAISACH, SOLUONGHIENTAI) 
...
Cuốn sách dành cho những thời thơ ấu đầy vết thương.',0,  0);
INSERT INTO SACH ( TENSACH, THELOAI, TACGIA, NGONNGU, NXB, NAMXB, URL_IMAGE, MOTA, LOAISACH,SOLUONGHIENTAI) 
...
“Một cách nhìn cuộc sống gần như hoàn chỉnh từ con mắt trẻ thơ… có sức mạnh sưởi ấm và làm tan nát cõi lòng, dù người đọc ở lứa tuổi nào.” - The National',0,  0);
INSERT INTO SACH ( TENSACH, THELOAI, TACGIA, NGONNGU, NXB, NAMXB, URL_IMAGE, MOTA,LOAISACH, SOLUONGHIENTAI) 
...
cuốn sách còn có thể hấp dẫn và thực sự có ích cho người lớn trong quan hệ với con mình.',0, 0);
INSERT INTO SACH ( TENSACH, THELOAI, TACGIA, NGONNGU, NXB, NAMXB, URL_IMAGE, MOTA, LOAISACH,SOLUONGHIENTAI) 
...
Công ty văn hóa Đông A đã chính thức phát hành lại bộ sách quý này dành cho bạn đọc chơi sách và mê truyện Tam Quốc diễn nghĩa.',0, 0);
INSERT INTO SACH ( TENSACH, THELOAI, TACGIA, NGONNGU, NXB, NAMXB, URL_IMAGE, MOTA,LOAISACH, SOLUONGHIENTAI) 
...
cho đến khi những bí mật đằng sau vùng đất lý tưởng này được hé lộ!',0, 0);
INSERT INTO SACH ( TENSACH, THELOAI, TACGIA, NGONNGU, NXB, NAMXB, URL_IMAGE, MOTA, LOAISACH,SOLUONGHIENTAI) 
...
Chính vì thế mà cuốn sách chỉ có một cách đọc thôi: một mạch từ đầu đến cuối!', 0,0);
...
“Nếu muốn thằng bé trở về bình an vô sự, hãy công khai sự thật cho mọi người biết”. “Sự thật” đó rốt cuộc là gì? Và ai là hung thủ đã bắt cóc Yuta?', 1, 0);
INSERT INTO SACH ( TENSACH, THELOAI, TACGIA, NGONNGU, NXB, NAMXB, URL_IMAGE, MOTA,LOAISACH, SOLUONGHIENTAI) 
...
Câu chuyện thực sự gây lay động bởi những trang viết đầy hồi hộp và xúc động về gia đình, tình bạn, tình yêu.', 1, 0);
INSERT INTO SACH ( TENSACH, THELOAI, TACGIA, NGONNGU, NXB, NAMXB, URL_IMAGE, MOTA,LOAISACH, SOLUONGHIENTAI) 
...
Năm tháng qua đi, cô bé thích làm cảnh sát bênh vực cho lũ mèo năm xưa đã trưởng thành, giờ cô là một bà bảo mẫu thích kể chuyện cho các em nhỏ.', 0,0);
INSERT INTO SACH ( TENSACH, THELOAI, TACGIA, NGONNGU, NXB, NAMXB, URL_IMAGE, MOTA, LOAISACH,SOLUONGHIENTAI) 
...
Phần tranh vẽ minh họa sinh động, gần gũi giúp các em dễ dàng hơn trong việc tiếp cận và ghi nhớ câu chuyện.',0, 0);
INSERT INTO SACH ( TENSACH, THELOAI, TACGIA, NGONNGU, NXB, NAMXB, URL_IMAGE, MOTA, LOAISACH,SOLUONGHIENTAI) 
...
là lo sợ được mất và cả những tổn thương, những lần tự chữa lành.',0, 0);
INSERT INTO SACH ( TENSACH, THELOAI, TACGIA, NGONNGU, NXB, NAMXB, URL_IMAGE, MOTA, LOAISACH,SOLUONGHIENTAI) 
...
Trong những câu thơ đôi khi họ là những người lãng du cô đơn bước chân qua đám đông tranh cãi ồn ào và luôn khao khát tìm kiếm hạnh phúc.', 0, 0);
INSERT INTO SACH ( TENSACH, THELOAI, TACGIA, NGONNGU, NXB, NAMXB, URL_IMAGE, MOTA, LOAISACH,SOLUONGHIENTAI) 
...
Mong rằng “Dear, darling” sẽ là lời an ủi dịu dàng nhất dành cho bạn.',1, 0);
INSERT INTO SACH ( TENSACH, THELOAI, TACGIA, NGONNGU, NXB, NAMXB, URL_IMAGE, MOTA,LOAISACH, SOLUONGHIENTAI) 
...
Bước 5: Tra cứu đáp án theo chuyên đề ngữ pháp hoặc từng câu hỏi. Để lại bình luận nếu cần hỗ trợ giải đáp.',0, 0);
INSERT INTO SACH ( TENSACH, THELOAI, TACGIA, NGONNGU, NXB, NAMXB, URL_IMAGE, MOTA,LOAISACH, SOLUONGHIENTAI) 
...
Cũng theo ông, để chinh phục kỹ năng này, bạn cần quên đi những gì đã học, đồng thời thiết lập và duy trì vònglặptáitưduy.',0, 0);
INSERT INTO SACH ( TENSACH, THELOAI, TACGIA, NGONNGU, NXB, NAMXB, URL_IMAGE, MOTA,LOAISACH, SOLUONGHIENTAI) 
...
Thời gian trôi qua, bà hạ sinh một bé trai, tư dung thông minh lạ thường, đặt tên là Quỳnh.',0, 0);
...
Dốt văn nên hay vẽ. Đồng tác giả cuốn “Mẹ Yêu Ai Nhất?”',0, 0);
INSERT INTO SACH ( TENSACH, THELOAI, TACGIA, NGONNGU, NXB, NAMXB, URL_IMAGE, MOTA,LOAISACH, SOLUONGHIENTAI) 
...
Và chính những sự nỗ lực xoa dịu chính mình đó đã hóa thành những câu từ trong cuốn sách này, bất kể đau đớn thế nào.', 0,0);
INSERT INTO SACH ( TENSACH, THELOAI, TACGIA, NGONNGU, NXB, NAMXB, URL_IMAGE, MOTA,LOAISACH, SOLUONGHIENTAI) 
...
Cuốn sách này sẽ giúp mở rộng tiềm năng của trẻ tới vô hạn!', 0, 0);
INSERT INTO SACH ( TENSACH, THELOAI, TACGIA, NGONNGU, NXB, NAMXB, URL_IMAGE, MOTA,LOAISACH, SOLUONGHIENTAI) 
...
phương diện đánh giá khác nhau, cũng như có thêm kĩ năng vận dụng sự hài hước vào cuộc sống hàng ngày.',0,0);
INSERT INTO SACH ( TENSACH, THELOAI, TACGIA, NGONNGU, NXB, NAMXB, URL_IMAGE, MOTA, LOAISACH,SOLUONGHIENTAI) 
...
Thậm chí bạn cũng không muốn kể cho cha mẹ nghe vì sợ họ phải lo lắng cho mình, bạn chỉ có thể tự mình giải quyết, tự mình gánh chịu.',  0,0);
INSERT INTO SACH ( TENSACH, THELOAI, TACGIA, NGONNGU, NXB, NAMXB, URL_IMAGE, MOTA,LOAISACH, SOLUONGHIENTAI) 
...
thông qua bốn kĩ năng nghe, nói, đọc, viết, trong đó ưu tiên hai kĩ năng nghe và nói.',0,0);
INSERT INTO SACH ( TENSACH, THELOAI, TACGIA, NGONNGU, NXB, NAMXB, URL_IMAGE, MOTA,LOAISACH, SOLUONGHIENTAI) 
VALUES (N'Lịch Sử Và Địa Lí 6 (Kết Nối Tri Thức) (2023)',N'Sách giáo khoa',N'Nhiều Tác Giả',N'Tiếng việt',N'Giáo Dục Việt Nam', 2023, '~\img_web\LichSuVaDiaLi6.jpg',N'Lịch Sử Và Địa Lí 6 (Kết Nối Tri Thức) (2023)',0, 0);
INSERT INTO SACH ( TENSACH, THELOAI, TACGIA, NGONNGU, NXB, NAMXB, URL_IMAGE, MOTA, LOAISACH,SOLUONGHIENTAI) 
...
về những nỗ lực hoàn thiện không ngừng nghỉ trong thế giới của người trưởng thành.',0,0);
INSERT INTO SACH ( TENSACH, THELOAI, TACGIA, NGONNGU, NXB, NAMXB, URL_IMAGE, MOTA, LOAISACH,SOLUONGHIENTAI) 
...
nhắn nhủ đến chính mình của tương lai…', 0, 0);
INSERT INTO SACH ( TENSACH, THELOAI, TACGIA, NGONNGU, NXB, NAMXB, URL_IMAGE, MOTA, LOAISACH,SOLUONGHIENTAI) 
...
mạnh mẽ trưởng thành, làm một phiên bản chính mình hoàn hảo nhất.',0, 0);
...
INSERT INTO QUYDINH (KHOANGCACHNXB, MAXSACHMUON,MAXNGAYMUON) VALUES (8,5,4);--8 NĂM, 5 CUỐN TRONG 10 NGÀY, 4 TUẦN MƯỢN TỐI ĐA
